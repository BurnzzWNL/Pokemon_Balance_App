...
const TierList = () => {
  ...
  const tiers = [
    { 
      ...
      pokemon: ["Mew", "Blaziken", "Blissey", "Darkrai", "Gyarados", "Mewtwo", "Charizard", "Lapras", "Dragonite", "Meowscarada", "Talonflame", "Slowbro", "Sylveon"]
    },
    { 
      name: "S", 
      color: "linear-gradient(135deg, #e74c3c, #c0392b)", 
      pokemon: ["Blastoise", "Blaziken", "Venusaur", "Delphox", "Armarouge", "Clefable", "Goodra", "Duraludon", "Garchomp", "Latios", "Gardevoir", "Ho-oh", "Lucario", "Absol", "Pikachu", "Psyduck", "Espeon", "Sylveon", "Leafeon", "Umbreon", "Zoroark", "Gyarados", "Decidueye"]
    },
    { 
      name: "A", 
      color: "linear-gradient(135deg, #27ae60, #2ecc71)", 
      pokemon: ["Lapras", "Aegislash", "Machamp", "Talonflame", "Mamoswine", "Crustle", "Inteleon", "Zeraora", "Hoopa", "Gengar", "Greninja", "Scizor", "Gyarados", "Latias", "Espeon", "Dragapult", "Buzzwole", "Snorlax", "Wigglytuff", "Blissey", "Eldegoss", "Comfey", "Mimikyu", "Tyranitar", "Cinderace"]
    },
    { 
      name: "B", 
      color: "linear-gradient(135deg, #3498db, #2980b9)", 
      pokemon: ["Azumarill", "Dodrio", "Empoleon", "Pikachu", "Rapidash", "Greedent", "Alcremie", "Clefable", "Wigglytuff", "Chandelure", "Tsareena"]
    },
    { 
      name: "C", 
